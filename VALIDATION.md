...
| **B3** model choice matters | model family, similar size | qwen2.5:7b / mistral:7b / llama3.1:8b | 0.333 / 0.333 / 0.000 (llama3.3 judge) | large spread, safest-to-least | llama3.1 near-zero under both the original judge and an out-of-family gemma2:9b re-run (0.000 then 0.083); under gemma2 the absolute rates rise (qwen 0.50, mistral 0.58 to 0.67) but the ordering and the spread hold |
