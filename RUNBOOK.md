...
Consequence of output: none material | low-stakes external effect | materially affects a person | high-stakes decision about a person
...
The four capability rows (actions / touch / data / consequence) are the four Rigor drivers. You just collected them; Step 1 turns them into a level.

---

## Step 1 — Triage: set the Rigor Level (R1–R4)
...
| **Consequence** | none material | low-stakes external effect | materially affects a person | high-stakes decision about a person |
